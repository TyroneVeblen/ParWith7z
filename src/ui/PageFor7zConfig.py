...
class Ui_PageFor7zConfig(object):
    def setupUi(self, PageFor7zConfig):
        ...
        self.groupBox_2 = QGroupBox(PageFor7zConfig)
        ...
        QMetaObject.connectSlotsByName(PageFor7zConfig)
    # setupUi

    def retranslateUi(self, PageFor7zConfig):
        PageFor7zConfig.setWindowTitle(QCoreApplication.translate("PageFor7zConfig", u"7z\u914d\u7f6e", None))
        self.groupBox.setTitle(QCoreApplication.translate("PageFor7zConfig", u"\u538b\u7f29", None))
        self.label.setText(QCoreApplication.translate("PageFor7zConfig", u"\u89e3\u538b\u5b8c\u6210\u540e\u5220\u9664\u6e90\u6587\u4ef6\uff1a", None))
        self.is_delete_file_after_compress.setText("")
        self.label_2.setText(QCoreApplication.translate("PageFor7zConfig", u"\u538b\u7f29\u7b49\u7ea7\uff1a", None))
        self.compress_level.setItemText(0, QCoreApplication.translate("PageFor7zConfig", u"0 \u4ec5\u5b58\u50a8", None))
        self.compress_level.setItemText(1, QCoreApplication.translate("PageFor7zConfig", u"5 \u6807\u51c6\u538b\u7f29", None))
        self.compress_level.setItemText(2, QCoreApplication.translate("PageFor7zConfig", u"9 \u6781\u9650\u538b\u7f29", None))

        self.label_3.setText(QCoreApplication.translate("PageFor7zConfig", u"\u5206\u5377\u5927\u5c0f(MB)\uff1a", None))
        self.label_4.setText(QCoreApplication.translate("PageFor7zConfig", u"\u52a0\u5bc6\u6587\u4ef6\u540d\uff1a", None))
        self.is_encrypted_file_name.setText("")
        self.label_7.setText(QCoreApplication.translate("PageFor7zConfig", u"\u4ec5\u6587\u4ef6\u5939\u6a21\u5f0f\uff1a", None))
        self.is_folder_only.setText("")
        self.label_8.setText(QCoreApplication.translate("PageFor7zConfig", u"\u8def\u5f84\u9012\u5f52\u6df1\u5ea6\uff1a", None))
